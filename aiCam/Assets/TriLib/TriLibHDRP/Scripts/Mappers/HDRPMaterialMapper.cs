...
namespace TriLibCore.HDRP.Mappers
{
    ...
    public class HDRPMaterialMapper : MaterialMapper
    {
        ...
        {
            return AssetLoader.GetCompatibleMaterialMapperName() == "HDRPMaterialMapper";
        }
        ...
        {
            if (textureLoadingContext.UnityTexture == null && textureLoadingContext.MaterialMapperContext.VirtualMaterial.GenericPropertyIsSetAndValid(GenericMaterialProperty.EmissionMap))
            {
