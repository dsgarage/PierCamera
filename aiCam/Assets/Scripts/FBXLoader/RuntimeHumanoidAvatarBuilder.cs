...
namespace AICam.FBXLoader
{
    public class RuntimeHumanoidAvatarBuilder
    {
        ...
        //  PUBLIC API
        // ───────────────────────────────────────────────────────────
        public Avatar CreateHumanoidAvatarFromFBX(string modelName, GameObject root)
        {
            // ① ボーンマッピング
            ...
            {
                RuntimeHumanoidAvatarBuilderDebugHelper.DumpHierarchy(root, "Required bone missing");
                return null;
            }
            ...
            {
                RuntimeHumanoidAvatarBuilderDebugHelper.DumpHierarchy(root, "Hierarchy invalid");
                return null;
            }
                                                  ...
                                                  string model)
        {
            ...
            if (!avatar.isValid || !avatar.isHuman)
            {
                ...
                RuntimeHumanoidAvatarBuilderDebugHelper.DumpHierarchy(root, "BuildHumanAvatar failed");
                return null;
            }
            return avatar;
        }
        ...
        private static SkeletonBone[] GenerateSkeletonBones(GameObject root)
        {
            ...
            void Rec(Transform t)
            {
                list.Add(new SkeletonBone
                {
                    ...
                    scale    = t.localScale          // スケールはそのまま使用
                });
